...
- Tools should be invocable both as:
  - `dm tools <name>`
  - `dm -t <name>`
- Keep tool aliases consistent (`search/s`, `rename/r`, `recent/rec`, `clean/c`, `read/f`, `grep/g`).
...
| `tk_*` | Toolkit Manager | `plugins/Toolkit_Manager_Toolkit.ps1` |
| `net_*` | Network Toolkit | `plugins/Network_Toolkit.ps1` |
| `pkg_*` | Winget Toolkit | `plugins/Winget_Toolkit.ps1` |
| `arc_*` | Archive Toolkit | `plugins/Archive_Toolkit.ps1` |
| `sched_*` | Scheduler Toolkit | `plugins/Scheduler_Toolkit.ps1` |
